...
namespace FOSCBot.Core.Domain.Miscellaneous.Upct
{
    public class UpctMiscellaneousActionHandler : ActionHandler<UpctMiscellaneousAction>
    {
        ...
        {
			var stickerString = RandomProvider.GetThreadRandom().NextDouble() > 0.2d ? "CAACAgQAAxkBAAJNW16eEHOauvBkLuaD-jL95s86vn2qAAJuAwACmOejAAEys6bCdTOD7RgE" : "CAACAgQAAxkBAAJNXV6eEJLQHwl-8el7YOYYJUF9l8ymAAJZAgACkNStBjfoiv3ywvd8GAQ";
