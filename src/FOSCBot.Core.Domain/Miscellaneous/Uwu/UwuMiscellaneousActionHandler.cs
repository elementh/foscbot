...
{
    public UwuMiscellaneousActionHandler(INavigatorContext ctx) : base(ctx)
    {
    }

    public override async Task<Unit> Handle(UwuMiscellaneousAction request, CancellationToken cancellationToken)
    {
